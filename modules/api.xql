...
module namespace api="http://www.digital-archiv.at/ns/aratea-app/api";
declare namespace rest = "http://exquery.org/ns/restxq";
declare namespace tei = "http://www.tei-c.org/ns/1.0";
import module namespace functx = "http://www.functx.com";
import module namespace app="http://www.digital-archiv.at/ns/aratea-app/templates" at "app.xql";
...
declare 
    %rest:GET
    %rest:path("/aratea-app/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/aratea-app/dt/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/aratea-app/{$collection}/{$id}/{$format}")
