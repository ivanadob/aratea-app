...
declare 
    %rest:GET
    %rest:path("/aratea-digital/api/about")
...
function api:api-about($format as xs:string*, $pageNumber as xs:integer*, $pageSize as xs:integer*) {
    let $endpoints := 
        <result>
            <ep>
                <url>/aratea-digital/api/collections</url>
            ...
            <ep>
                <url>{"/aratea-digital/api/collections/{$collection}"}</url>
...
declare 
    %rest:GET
    %rest:path("/aratea-digital/api/collections")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/aratea-digital/api/collections/{$collection}")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare
    %rest:GET
    %rest:path("/aratea-digital/api/entities")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/aratea-digital/api/collections/{$collection}/{$id}")
...
declare
    %rest:GET
    %rest:path("/aratea-digital/api/entities/{$id}")
...
declare
    %rest:GET
    %rest:path("/aratea-digital/api/entity-types")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/aratea-digital/api/entity-types/{$id}")
